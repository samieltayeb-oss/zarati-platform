...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const t = (await getDictionary(lang as Locale)).terms
...
export default async function TermsPage({ params }: Props) {
  ...
  const sections = [
    { title: t.statusTitle,     body: t.statusBody     },
  ...
  return (
    <>
      <section className="bg-gradient-to-b from-navy to-navy-dark text-white py-16 sm:py-20">
